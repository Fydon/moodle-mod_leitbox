...
// Privacy metadata.
$string['privacy:metadata:Adaptive Review_progress'] = 'Information about user progress on Adaptive Review.';
$string['privacy:metadata:Adaptive Review_progress:userid'] = 'The user ID.';
$string['privacy:metadata:Adaptive Review_progress:cardid'] = 'The card ID.';
$string['privacy:metadata:Adaptive Review_progress:box_number'] = 'The Leitner box the card is currently in.';
$string['privacy:metadata:Adaptive Review_progress:count_correct'] = 'The number of times the user answered the card correctly.';
$string['privacy:metadata:Adaptive Review_progress:count_wrong'] = 'The number of times the user answered the card incorrectly.';
$string['privacy:metadata:Adaptive Review_progress:last_reviewed'] = 'The timestamp when the card was last reviewed.';
